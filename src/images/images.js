export const regionalProducts = [
  ...
  {
    id: 10,
    images: ['./images/wyrobyregionalne/33 zł_kg - Bundz z czosnkiem niedźwiedzim.jpg'],
    price: '33 zł/kg',
    description: 'Bundz z czosnkiem niedźwiedzim'
  },

  {
    id: 7,
    images: ['./images/wyrobyregionalne/33 zł_kg - Bryndza.jpg'],
    price: '33 zł/kg',
    description: 'Bryndza'
  },
  {
    id: 8,
    images: ['./images/wyrobyregionalne/33 zł_kg - Bundz naturalny.jpg'],
    price: '33 zł/kg',
    description: 'Bundz naturalny'
  },
  {
    id: 9,
    images: ['./images/wyrobyregionalne/33 zł_kg - Bundz z czarnuszką.jpg'],
    price: '33 zł/kg',
    description: 'Bundz z czarnuszką'
  },

  {
    id: 10,
    images: ['./images/wyrobyregionalne/33 zł_kg - Bundz z żurawiną.jpg'],
    price: '33 zł/kg',
    description: 'Bundz z żurawiną'
  }
];

export const folkProducts = [
  {
    id: 10,
    images: [
