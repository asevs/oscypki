          ...
          <div className="container mx-auto px-8 lg:flex">
            <div className="text-center lg:text-left lg:w-1/2">
              <p className="text-xl lg:text-2xl p-6 font-light text-justify">
                Codziennie dokładamy wszelkich starań, aby produkty, z których wytwarzamy nasze
                wyroby były pozbawione konserwantów, zanieczyszczeń i zbędnej chemii. Abyśmy mogli
                jeść rzeczy, jak dawniej nasi dziadkowie: zdrowe pełne witamin i minerałów, po które
